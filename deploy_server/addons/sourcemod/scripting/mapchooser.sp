...
public OnPluginStart()
{
	...
	g_Cvar_ExcludeMaps = CreateConVar("sm_mapvote_exclude", "2", "Specifies how many past maps to exclude from the vote.", _, true, 0.0);
	g_Cvar_IncludeMaps = CreateConVar("sm_mapvote_include", "4", "Specifies how many maps to include in the vote.", _, true, 2.0, true, 6.0);
